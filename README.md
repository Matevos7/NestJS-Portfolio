...
If you are getting an error about auth.
...
5. Branch name example: feature/registration-flow-implementation
6. Commit message example: feat(registration): Implement registration flow
...
```
Shared modules descripton put here
```
